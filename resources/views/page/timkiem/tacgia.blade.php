                            ...
                            <div class="image">
                                <div style="position: relative;">
                                    <a href="{{ route('chitietsanpham', $item->id) }}">
                                        <img src="{{ Storage::disk('book')->url($item->anhbia) }}"
                                            alt="{{ $item->tensach }}">
                                    </a>
                                    @if ($item->khuyenmai > 0)
                                        <span class="saleprice"
                                            style="background:url({{ url('/image/saleprice.png') }}) no-repeat;">
                                            {{ $item->khuyenmai }}%
                                        </span>
                                    @endif
                                </div>
                                ...
                                <div class="product_composer"><a href="{{ url('/tacgia/'.$item->tacgia) }}">{{ $item->tacgia }}</a></div>
                                <div class="prices">
                                    {{ number_format($item->dongia - ($item->dongia * $item->khuyenmai) / 100, 0, ',', '.') }}₫
                                </div>
