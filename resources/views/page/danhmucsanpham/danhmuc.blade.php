...
@endsection
@section('content')
	<div class="pathway"><ul><li><a href="http://127.0.0.1:8000/home" title="Trang chủ">Trang chủ \</a></li><li>@section('tendanhmuc')
	    @show</li></ul>
    </div>
    <div class="clear"></div>
	<div id="container">
                ...
                @foreach($sach as $item)
                    <div class="product">
                        <div class="image">
                            ...
                            <div class="product_composer"><a href="#">{{ $item->tacgia }}</a></div>
                            <div class="prices">{{ number_format($item->dongia - $item->dongia * $item->khuyenmai / 100, 0, ",", ".") }}₫</div>
                            <div class="rootprices">{{ number_format($item->dongia, 0, ",", ".") }}₫</div>
                            <div class="rating">
