            ...
            <form action="{{ route('timkiem_key') }}" method="get">
                <div style="width: 440px;height: 30px;margin-top:13px;position: relative;bottom: 57px;left: 342px;">
                    ...
                    <input type="submit" value="Tìm"
                        style="width: 44px;float: right;height: 30px;text-align: center;font-weight: bold;color: #00cc66;background: white">
            ...
            <div style="float: right;bottom:87px;position: relative;height: 30px;" id="login">
                <label style="margin-right: 5px;">
                    @if (!Auth::guard('customers')->check())
                        <div
                            style="margin-right: 30px; background: white;width: 100px; height: 30px;line-height: 30px;text-align: center;overflow: hidden;">
                    ...
                    @else
                        <div id="users" style="margin-right: 30px; position: relative; display: inline-block;">
                            <div
                                style="background: white;width: 100px; height: 30px;line-height: 30px;text-align: center;overflow: hidden;cursor: pointer;">
                                {{ Auth::guard('customers')->user()->username }}
                            </div>
                            <ul id="user_menu"
                                style="display: none; position: absolute; top: 30px; left: 0; background: white; border: 1px solid #ccc; list-style: none; padding: 5px 0; z-index: 100; width: 160px;">
                                <li style="padding: 5px 15px;"><a href="{{ url('thongtincanhan') }}"
                                        style="color: black;">Thông tin cá nhân</a></li>
                                <li style="padding: 5px 15px;"><a href="{{ url('donhang') }}" style="color: black;">Đơn hàng
                                        của tôi</a></li>
                                <li style="padding: 5px 15px;"><a href="{{ url('kh_logout') }}" style="color: black;">Đăng
                                        xuất</a></li>
                            </ul>
                        </div>
                    @endif
                                ...
                                <div class="cart-item">
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#"><img
                                                src="{{ Storage::disk('book')->url($product['item']['anhbia']) }}"
                                                alt="" style="width: 50px;height: 70px;"></a>
                                        <div class="media-body" id="cart_body">
                                            ...
                                            <span class="cart-item-amount">
                                                <input type="number" name="qty" id="qty"
                                                    onchange="changeqty(this,{{ $product['item']['id'] }})"
                                                    value="{{ $product['qty'] }}" min="1"
                                                    style="width: 40px;border: 1px solid lavender;text-align: center;">
