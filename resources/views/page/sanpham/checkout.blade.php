                        ...
                        <div class="col-sm-6">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="gender" type="radio" class="radio" name="gender" value="nam" checked="checked" style="width: 10%"><span style="margin-right: 10%">Nam</span>
                                        <input id="gender" type="radio" class="input-radio" name="gender" value="nữ" style="width: 10%"><span>Nữ</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="first"><label for="email">Email (*)</label></td>
                                    <td><input type="email" name="email" placeholder="example@gmail.com" required class="input_style"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><textarea id="notes" name="notes" class="input_style" rows="7" ></textarea></td>
                                </tr>
                            </table>
                        </div>
