...
@section('style')
    ...
    <style>
        ...
        .products .image .saleprice {
            background: url("{{ url('/image/saleprice.png') }}") no-repeat;
            font-weight: bold;
            text-align: center;
            color: #FFF;
            font-size: 13px;
                    ...
                    <div class="product_info">
                        ...
                        <div class="groups">
                            <div class="viewfields">
                                <span>Tác giả: <a href="" title="{{ $sach->tacgia }}">{{ $sach->tacgia }}</a></span>
                                <span>Phát hành: <a href="" title="">{{ $nxbs->tennhaxuatban }}</a></span>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="groups">
                        ...
                        <div class="prices_contener">
                            <div class="prices">
                                <div class="saleprice">
                                    <span
                                        id="saleprice">{{ number_format($sach->dongia - ($sach->dongia * $sach->khuyenmai) / 100, 0, ',', '.') }}
                                        ₫</span>
                                </div>
                                <div class="vrootprice" id="rootprice">Giá bìa:
                                    <span>{{ number_format($sach->dongia, 0, ',', '.') }} ₫</span></div>
                                <div class="yousave" id="yousave">Tiết kiệm:
                                    {{ number_format(($sach->dongia * $sach->khuyenmai) / 100, 0, ',', '.') }} ₫<span>
                                        @if ($sach->khuyenmai > 0)
                                            ({{ $sach->khuyenmai }})%
                                        @endif
                                    </span></div>
                        ...
                        <div class="intro">
                            <div class="block " id="content_ViewProducts">
                                <div class="blockcontent">
                                    ...
                                    <p>
                                        <i class="fa fa-check"></i><span style="font-size:14px;">Giao h&agrave;ng miễn
                                            ph&iacute; trong nội th&agrave;nh TP. HCM với đơn h&agrave;ng&nbsp; <span
                                                style="color:#33cc33;"><strong>&ge; 150.000 đ</strong></span></span>
                                    </p>
                                    <p>
                                        <i class="fa fa-check"></i><span style="font-size:14px;">Giao h&agrave;ng miễn
	...
	<td class="values">
		<a href="" title="TiHabooks">TiHabooks</a>
                    ...
                    <tr class="field_view_contenner row0">
                        ...
                        <td class="values">
                            {{ \Carbon\Carbon::parse($chitietsanpham->ngayphathanh)->format('d/m/Y') }}
                        </td>
                    </tr>
                    <tr class="field_view_contenner row1">
                        <td class="title">
                    ...
                    <div style="position:relative; padding:0 0; overflow:hidden; height:320px;">
                        @foreach ($sach_lienquan as $sach_lienquans)
                            <div class="product_contener">
                                <div class="products">
                                    <div class="image"><a href="{{ route('chitietsanpham', $sach_lienquans->id) }}"
                                            title=""><img
                                                src="{{ Storage::disk('book')->url($sach_lienquans->anhbia) }}"
                                                alt="" title="" /></a>
                                    ...
                                    <div class="productname">
                                        <a href="{{ route('chitietsanpham', $sach_lienquans->id) }}"
                                            title="">{{ $sach_lienquans->tensach }}</a>
                                    </div>
                                    <div class="fields"> <span><a href=""
                                                title="">{{ $sach_lienquans->tacgia }}</a></span></div>
                                    @if ($sach_lienquans->khuyenmai > 0)
                                        <div class="prices">
                                            {{ number_format(($sach_lienquans->dongia * (100 - $sach_lienquans->khuyenmai)) / 100, 0) }}₫
                                        </div>
            ...
            <h3>
                <ul id="tabnav">
                    <li><a href="javascript:" class="active" id="tab0" onclick="ShowTab(0)">Nhận xét của khách
                            hàng</a></li>
                    <li><a href="javascript:" id="tab1" onclick="ShowTab(1)"><i class="fa fa-facebook-square"></i>
                            Thảo luận</a></li>
                </ul>
            </h3>
            <a name="comment"></a>
                    ...
                    <div id="div0">
                        <div class="comment_list">
                            <div class="fb-comments"
                                ...
                                data-width="1140" data-numposts="10"></div>
                        </div>
                    </div>
                </div>
            @endif
